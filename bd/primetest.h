...
bool primetest(mpz_t n, int64_t R)
{
  countprimetests++;
  //int128 q=(n-1)/R;
  ...
  //int64_t c1= q % R;
  int64_t c1= mpz_mod_ui(save,Q,R);
  //int64_t c2= (q-c1)/R;
  mpz_sub_ui(save,Q,c1);
  mpz_fdiv_q_ui(save,save,R);
  int64_t c2= mpz_get_ui(save);

...
const int64_t numintervals=1024;  // fits in 16kb cache L1d
...
int main(int argc, char *argv[])
{
  ...
  char filename[100];
  sprintf(filename,"/scratch/qk9/js8067/data/%04d.out",id);
...
//for(uint64_t myn=5.5e12+id*nchunk; myn<1e13; myn+=np*nchunk)
//for(uint64_t myn=9.436e12+id*nchunk; myn<1e13; myn+=np*nchunk)
//for(uint64_t myn=9.438e12+id*nchunk; myn<1e13; myn+=np*nchunk)
//for(uint64_t myn=9.57e12+id*nchunk; myn<1e13; myn+=np*nchunk)
for(uint64_t myn=1.9e13+id*nchunk; myn<1e14; myn+=np*nchunk)
{
